...
(function()) {
var storeApp = angular.module('GemStore', ["StoreDirectives"]);
})();
 (function() {
...
(function(){
    ...
    app.directive("productDescription", function() {
      return {
        restrict: 'E',
        templateUrl: "/assets/store_app/gems/views/description-0c8a9a3f7c1ed9bf55c87543b52a5f72.html"
      };
    });
    ...
    app.directive("productReviews", function() {
      return {
        restrict: 'E',
        templateUrl: "/assets/store_app/gems/views/reviews-c16a7367aef56c151d35aa3cac9a6cd0.html"
      };
    });
    ...
    app.directive("productSpecs", function() {
      return {
        restrict:"A",
        templateUrl: "/assets/store_app/gems/views/specs-19f46eca92bbbace51e448c21b86ce06.html"
      };
    });
    ...
    app.directive("productTabs", function() {
      return {
        restrict: "E",
        templateUrl: "/assets/store_app/gems/views/tabs-5a4bd136e54b4e0d8d787c4c483635bc.html",
        controller: function() {
          this.tab = 1;
    ...
    app.directive("productGallery", function() {
      return {
        restrict: "E",
        templateUrl: "/assets/store_app/gems/views/gallery-8cad3e5bb14a0a14c36888b85ad95407.html",
        controller: function() {
          this.current = 0;
...
(function(){
    ...
    app.directive("productDescription", function() {
      return {
        restrict: 'E',
        templateUrl: "products/product-description.html"
      };
    });
    ...
    app.directive("productSpecs", function() {
      return {
        restrict:"A",
        templateUrl: "products/product-specs.html"
      };
    });
    ...
    app.directive("productGallery", function() {
      return {
        restrict: "E",
        templateUrl: "products/product-gallery.html",
        controller: function() {
          this.current = 0;
          this.setCurrent = function(imageNumber){
            this.current = imageNumber || 0;
